...
def call_emergency():
    """
    Initiates a call to the emergency contact using Twilio API.
    """
    try:
        ...
        call = client.calls.create(
            ...
            url="http://demo.twilio.com/docs/voice.xml"  # This URL can be customized
        )
        return f"Emergency call initiated. Call SID: {call.sid}"
    except Exception as e:
